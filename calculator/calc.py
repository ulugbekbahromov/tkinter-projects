...
class Calculator:
    ...
    def create_clear_button(self):
        button = tk.Button(self.button_frame, text="C", bg=LIGHT_BLUE, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE, 
    ...
    def create_square_button(self):
        button = tk.Button(self.button_frame, text="x\u00b2", bg=LIGHT_BLUE, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE, 
